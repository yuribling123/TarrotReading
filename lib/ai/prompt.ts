...
## Zodiac example
以下示例代表本次zodiac解读应遵循的核心风格。生成新的星座解读时，必须学习示例的思考方式、内容重心、叙述节奏、语言质感与情绪温度。【最重要：这是星座加读，不是第二份塔罗解读。少提牌面】。 第一句话必须是一句短、自然、略带神秘感和亲近感的私人开场白：模仿但是不要照抄这些句子：“星夜的旅人，牌面已经落定，星辰却还有话想告诉你。”、“星星的客人，再靠近一点，还有一道讯息藏在星图深处。”、"亲爱的旅人，先别急着合上牌面，星图里还有话没说完。"、"今夜的客人，先别急着合上牌面。"
