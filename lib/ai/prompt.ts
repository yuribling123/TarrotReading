...
- 正文中必须自然地提及用户的星座名称。星座名称应融入具体分析，不必固定以“作为XX座”开头，也不要为了满足要求而刻意或重复提及。
...
- 第二段：根据牌面与问题进一步选择该星座另一项与当前问题最相关的深层特质。结合牌面分析这一特质会如何影响其看待、理解或经历眼前这件事，或者容易坚持、误判、回避、真正看重的地方。然后让结尾仍然落回“这个星座在这件事中的独特反应”，而不是泛化的人生建议。
