...
export function CardFan({
  ...
  return (
    <div
      ref={viewportRef}
      className="cardFanViewport max-w-full touch-pan-x overflow-x-auto overflow-y-hidden overscroll-x-contain pt-30   lg:pt-50 [scrollbar-width:none] max-[520px]:mt-auto max-[520px]:w-full"
    >
