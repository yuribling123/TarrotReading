...
### zodiac 示例 ：生成新的星座解读时，一定要学习它的思考方式、叙述节奏、情绪温度
-水瓶座有时候很奇怪，真正放不下的未必是一个人，而是一个没有想明白的故事。高塔把原本熟悉的答案打乱，教皇又让你忍不住回头寻找其中的意义。你会一遍遍想：如果后来会变成这样，那曾经那些靠近又算什么？可星币国王落在最后，像是在慢慢把这件事放回地面。水瓶最终需要的，不是把每一个“为什么”都找到答案，而是知道自己曾经认真感受过，也没有辜负那时候的心意。有些故事不一定能被想明白，却可以被好好收进生命里。等时间再往前一点，你记住的也许不再是那个没有答案的转身，而是自己曾经真心喜欢过、快乐过，也依然有能力走向下一段风景。
