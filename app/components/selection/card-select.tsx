...
export function CardSelect({
  ...
  return (
    <div>
      <section className=" relative px-1 pt-60 [--selection-card-width:90px] max-[860px]:[--selection-card-width:102px] max-[520px]:flex  max-[520px]:flex-col max-[520px]:pt-25 max-[520px]:[--selection-card-width:clamp(50px,19vw,82px)]">
