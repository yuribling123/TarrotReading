...
import { HomeLunarPath } from "@/app/components/home/home-lunar-path";
...
export function Feedback() {
    ...
    return (
        <div className=" flex flex-col items-center mt-4 ">
            ...
            <p className="mt-3 text-[10px] text-[#595858]/80 self-center">听说留下共鸣的人，牌意更容易被宇宙收到 ⁺˖ </p>
            <Button size="lg" variant="default" onClick={handleOnClick}  disabled={feedback || isPending} className="mt-5 w-22 self-center">
