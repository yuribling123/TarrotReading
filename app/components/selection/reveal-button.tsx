        ...
        */}
        ...
        >
          ...
          */}
          ...
          <span
            aria-hidden="true"
            className={`absolute inset-0 z-20 flex items-center justify-center text-[12px] text-[#FFFEFC] transition-all duration-300 ${isComplete ? "scale-100 opacity-100" : "scale-75 opacity-0"}`}
          >
            ✦
          </span>
        </button>
