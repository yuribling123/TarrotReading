...
export function SelectedZodiac({ zodiac }: SelectedZodiacProps) {
  ...
  return (
    <div className="relative mx-auto mb-5 flex h-10 w-fit animate-in items-center justify-center gap-4 rounded-full bg-[#fffdf8]/65 px-3 pl-0 shadow-[0_5px_18px_rgba(127,91,31,0.10)] backdrop-blur-sm fade-in zoom-in-90 duration-500 before:absolute before:inset-[-7px] before:-z-10 before:rounded-full before:bg-[#69547f]/24 before:blur-xl">
      <span
        aria-hidden="true"
