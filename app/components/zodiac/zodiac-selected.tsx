...
export function SelectedZodiac({ zodiac }: SelectedZodiacProps) {
  ...
  return (
    <div className="relative text-[#7f5469]/88 mx-auto  px-5 flex w-fit animate-in items-center justify-center gap-1 rounded-[15px]  before:absolute before:inset-[-7px] before:-z-10 before:rounded-full before:bg-[#69547f]/ before:blur-xl">
