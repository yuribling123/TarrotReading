...
export function CardFan({
  ...
  return (
    <div
      ref={viewportRef}
      className="cardFanViewport max-w-full translate-y-[10px] touch-pan-x overflow-x-auto overflow-y-hidden overscroll-x-contain pt-8 pb-16 [scrollbar-width:none] max-[520px]:mt-auto max-[520px]:w-full"
    >
