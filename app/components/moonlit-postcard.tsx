    ...
    <>
      <button
        ...
        className={`
          ...
          overflow-visible
          bg-transparent
          drop-shadow-[0_5px_9px_rgba(91,69,105,0.14)]
          transition
          duration-300
          hover:-translate-x-1
      ...
      >
        ...
        >
          ...
          >
            ...
            <path
              d="m7 40 15.7-14.3M51 40 35.3 25.7"
              stroke="currentColor"
              strokeWidth=".85"
              opacity=".28"
            />
              ...
              ${
                isRead
                  ...
                  : `
                    ...
                    border-transparent
                    bg-[#8d7898]
                    shadow-[0_2px_5px_rgba(76,56,86,0.25)]
                  `
              }
            `}
          >
            ...
            <>
              <span
                className="
                  ...
                  rounded-full
                  bg-[#c9afd2]
                  shadow-[0_0_7px_2px_rgba(179,148,189,0.38)]
                "
                aria-hidden="true"
              />
              ...
              <span
                className="
                  moonlit-letter-spark-secondary
                  pointer-events-none
                  absolute
                  right-[9px]
                  top-[13px]
                  ...
                  rounded-full
                  bg-[#e1d0e6]
                  shadow-[0_0_5px_1px_rgba(199,174,208,0.35)]
                "
                aria-hidden="true"
              />
            </>
            ...
            >
              <span
                className="
                  ...
                  p-7
                  text-[#67566f]
                  shadow-[0_24px_70px_rgba(54,39,63,0.24)]
              ...
              >
                ...
                <span className="absolute inset-x-0 top-[43%] block text-center">
                  ...
                  <span className="block text-sm tracking-[0.18em]">
                    寄往：此刻的你
                  </span>

                  <span className="mt-4 block text-[10px] tracking-[0.12em] text-[#a092a7]">
                    轻触翻开
                  </span>
                </span>
              </span>
              ...
              <span
                ...
                "
              >
                <span className="block text-[10px] tracking-[0.22em] text-[#907c99]">
                  来自彼岸的你 · {displayDate}
                </span>
